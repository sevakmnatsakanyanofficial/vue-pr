  ...
  let returner = {
    ...
    resolve: {
      ...
      alias: {
        ...
        'mixins': path.resolve(__dirname, 'src/assets/vue/mixins/')
      }
    },
    ...
    module: {
      rules: [
        ...
        {test: /\.vue$/, exclude: /node_modules(\/|\\)(?!(vue2-google-maps)(\/|\\)).*/, loader: 'vue-loader', options: {loaders: {js: {loader: 'babel-loader', options: {presets: ['env'], plugins: ['transform-object-rest-spread']}}}}},
